...
import 'package:mobile_app/features/content_creator/dashboard/presentation/pages/completed_project_details_page.dart';
...
class _CompletedProjectsPageState extends State<CompletedProjectsPage> {
  ...
  Widget _projectCard({
    ...
    final rating = 5.0; // This should come from ratings API
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => CompletedProjectDetailsPage(contractId: contract.contractId),
          ),
        );
      },
      child: Container(
